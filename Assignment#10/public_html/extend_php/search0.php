...
<html>
	...
	<div class = "row">
		 ...
		 <?php
		    ...
		    $sql = "select a.MName, Owings.OAmt owes, b.MName `to`,
                        Groups.GName `in`, Transactions.Date since
                        from Members a , Owings, Members b, Groups, Transactions
                        where a.MID = Owings.MID_owes and
                            b.MID = Owings.MID_owedto and Groups.GID =
                            a.GID and Owings.TID = Transactions.TID
                        group by Owings.OID

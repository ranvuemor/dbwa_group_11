...
<html>
	...
	<div class = "row">
		 ...
		 <?php
		    ...
		    $sql = "select a.MName, Settled.SAmt settled, 
            Transactions.Date `on`, b.MName `with` 
            from Members a, Settled, Transactions, Members b 
            where 
                a.MID = Settled.MID_paidby and 
                Settled.TID = Transactions.TID and 
                b.MID = Settled.MID_paidto 
